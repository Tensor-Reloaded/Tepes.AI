...
from components.Crawler.DeclarationCrawler.constants import DECLARATII_INTEGRITATE_WEBSITE
from components.Crawler.DeclarationCrawler.declaration_parser import get_parser, ARGUMENTS
